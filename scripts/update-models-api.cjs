...
const aiModelCostSchema = z.strictObject({
  input: z.number(),
  output: z.number(),
...
const aiModelLimitSchema = z.strictObject({
  context: z.number(),
  input: z.number().optional(),
  output: z.number(),
})

const aiModelProviderOverrideSchema = z.strictObject({
  npm: z.string().optional(),
  api: z.string().optional(),
  shape: z.enum(['completions']).optional(),
})

const aiModelConfigSchema = z.strictObject({
  id: z.string(),
  name: z.string(),
...
const aiProviderDefinitionSchema = z.strictObject({
  id: z.string(),
...
const aiProviderDefinitionsSchema = z.record(z.string(), aiProviderDefinitionSchema)
